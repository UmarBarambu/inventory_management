...
class _AddProductState extends State<AddProduct> {
  ...
  final ProductDatabase _productDatabase = ProductDatabase(); // Instance of ProductDatabase
...
void _showSelectionDialog(String type) async {
  ...
  showDialog<String>(
              ...
              children: [
                ...items.isEmpty
                    ...
                    : items.map((item) => RadioListTile<String>(
                          ...
                          value: item.id,
                          groupValue: type == 'Category' ? _categoryController.text : _vendorController.text,
                          onChanged: (value) {
                            Navigator.of(context).pop(value); // Return the selected value
                          },
                        )),
                TextButton(
                  onPressed: () {
    ...
    if (selectedItemId != null) {
      final selectedItem = items.firstWhere((item) => item.id == selectedItemId);
      if (type == 'Category') {
        _categoryController.text = selectedItem.name; // Use name if displaying name
      } else if (type == 'Vendor') {
        _vendorController.text = selectedItem.name; // Use name if displaying name
      }
    }
  });
}
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: textInputD.copyWith(hintText: 'Select a category'),
                    ...
                    TextFormField(
                      ...
                      decoration: textInputD.copyWith(hintText: 'Select a vendor'),
