    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          List<double> totalProductValues = productData.map((data) => data['totalProductValue'] as double).toList(); // Assuming 'totalValue' is the field name
                    ...
                    child: SizedBox(
                      ...
                      child: BarChart(
                        BarChartData(
                          ...
                          maxY: totalProductValues.isNotEmpty
                              ? totalProductValues.reduce((a, b) => a > b ? a : b).toDouble() * 1.1
